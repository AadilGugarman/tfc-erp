...
export const FinancialSettings: React.FC = () => {
  ...
  const generateNextFY = () => {
    ...
    // Default to April 1st to March 31st (Indian FY)
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Input
              ...
              onChange={(e) => updateSettings('financial', { financialYearStart: e.target.value })}
            />
            ...
            <Input
              ...
              onChange={(e) => updateSettings('financial', { financialYearEnd: e.target.value })}
            />
          </div>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Input
              ...
              onChange={(e) => updateSettings('financial', { currencySymbol: e.target.value })}
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <Select
            ...
            onChange={(e) => updateSettings('financial', { taxSystem: e.target.value as any })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Select
              ...
              onChange={(e) => updateSettings('financial', { decimalPrecision: parseInt(e.target.value) })}
              options={[
            ...
            <Select
              ...
              onChange={(e) => updateSettings('financial', { roundOffRule: e.target.value as any })}
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Input
              ...
              onChange={(e) => updateSettings('financial', { invoicePrefix: e.target.value.toUpperCase() })}
            ...
            <Input
              ...
              onChange={(e) => updateSettings('financial', { invoiceStartingNumber: parseInt(e.target.value) || 1 })}
          ...
          <div className="p-4 rounded-lg bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-400">
                  How invoice numbers will appear
                </p>
              </div>
            </div>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Select
              ...
              onChange={(e) => updateSettings('financial', { dateFormat: e.target.value })}
            ...
            <Select
              ...
              onChange={(e) => updateSettings('financial', { timeFormat: e.target.value as any })}
          ...
          <Select
            ...
            onChange={(e) => updateSettings('financial', { timezone: e.target.value })}
