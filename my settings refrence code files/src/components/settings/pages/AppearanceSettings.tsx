          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {themeOptions.map((option) => {
              ...
              return (
                <button
                  key={option.value}
                  onClick={() => updateSettings('appearance', { theme: option.value as any })}
                  className={cn(
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <ColorPicker
            ...
            onChange={(color) => updateSettings('appearance', { accentColor: color })}
          />
            ...
            <div className="grid grid-cols-3 gap-4">
              {fontSizeOptions.map((option) => {
                ...
                return (
                  <button
                    key={option.value}
                    onClick={() => updateSettings('appearance', { fontSize: option.value as any })}
                    className={cn(
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
                  Animations help indicate state changes and improve the overall user experience.
                  Disable if you prefer a faster, more static interface.
                </p>
              </div>
            </div>
          </div>
