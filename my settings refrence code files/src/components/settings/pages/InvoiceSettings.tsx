...
import { InvoiceDetails } from '../../../types/settings';
...
export const InvoiceSettings: React.FC = () => {
  ...
  const handleSignatureChange = (url: string | null) => {
    updateSettings('invoice', { signature: url });
  };
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <Select
            ...
            onChange={(e) => updateSettings('invoice', { template: e.target.value as any })}
          ...
          <ColorPicker
            ...
            onChange={(color) => updateSettings('invoice', { invoiceColorTheme: color })}
          />
          ...
          <Toggle
            ...
            onCheckedChange={(checked) => updateSettings('invoice', { enableQRCode: checked })}
          ...
          <Toggle
            ...
            onCheckedChange={(checked) => updateSettings('invoice', { autoInvoiceNumber: checked })}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Input
              ...
              onChange={(e) => updateSettings('invoice', { defaultTax: parseFloat(e.target.value) || 0 })}
            ...
            <Input
              ...
              onChange={(e) => updateSettings('invoice', { dueDateDays: parseInt(e.target.value) || 30 })}
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <Textarea
            ...
            onChange={(e) => updateSettings('invoice', { termsAndConditions: e.target.value })}
            rows={4}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Toggle
              ...
              onCheckedChange={(checked) => updateSettings('invoice', { showCompanyDetails: checked })}
            ...
            <Toggle
              ...
              onCheckedChange={(checked) => updateSettings('invoice', { showPaymentDetails: checked })}
      ...
      <Card>
        ...
        <CardContent>
          <FileUpload
            ...
            accept="image/*"
            currentUrl={settings.invoice.signature || undefined}
            onFileChange={() => {}}
            onUrlChange={handleSignatureChange}
            maxSize={1 * 1024 * 1024}
          />
        </CardContent>
      </Card>
          ...
          <div className="bg-zinc-100 dark:bg-zinc-900 rounded-2xl shadow-2xl max-w-5xl w-full max-h-[92vh] flex flex-col overflow-hidden border border-zinc-200 dark:border-zinc-800">
            ...
            <div className="p-6 md:p-10 overflow-y-auto flex-1 bg-zinc-100 dark:bg-zinc-950">
              ...
              >
                  ...
                  <div className="flex-1 pr-4">
                    ...
                    {settings.company.phone && (
                      <p className="text-sm font-medium text-zinc-700 flex items-center gap-1.5 mt-1">
                        <span className="text-zinc-400">📞</span> {settings.company.phone}
                      </p>
                    )}
                    ...
                    {settings.company.city && settings.company.state && (
                      <p className="text-sm text-zinc-600 font-medium mt-0.5">
                        {settings.company.city}, {settings.company.state} - {settings.company.pincode}
                      </p>
                    )}
                  </div>
                ...
                <div className="grid grid-cols-2 gap-8 py-6 border-b border-zinc-200 bg-zinc-50/50 px-4 rounded-lg my-4">
                  <div>
                ...
                {/* Payment Summary */}
                <div className="py-6 border-t-2 border-zinc-200 mt-4">
                ...
                {/* Notes */}
                {invoiceData.notes && (
                  <div className="py-5 border-t border-zinc-200 mt-2">
                ...
                {/* Footer section */}
                <div className="pt-8 pb-4 mt-6 border-t border-zinc-200">
                  <div className="flex items-end justify-between">
                    ...
                    {settings.invoice.enableQRCode && (
                      <div className="ml-8 flex flex-col items-center bg-zinc-50 p-3 rounded-xl border border-zinc-200 shadow-xs">
                        ...
                        <p className="text-xs font-bold text-zinc-600 mt-2 tracking-wide uppercase">Scan to Pay / Verify</p>
                      </div>
                    )}
                  </div>
            ...
            <div className="sticky bottom-0 flex items-center justify-between px-6 py-4 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 z-20 shadow-md">
              <div className="text-xs text-zinc-500 font-medium hidden sm:block">
                💡 Tip: Use <kbd className="px-1.5 py-0.5 bg-zinc-100 dark:bg-zinc-800 rounded border border-zinc-200 dark:border-zinc-700">Ctrl + P</kbd> or click Print for perfect A4 output.
              </div>
              <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
                <Button variant="outline" onClick={() => setShowPreview(false)} className="font-medium">
                  Close
                </Button>
                <Button variant="outline" onClick={handlePrint} className="font-semibold bg-blue-50 hover:bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 border-blue-200 dark:border-blue-800">
                  <Printer className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                  Print A4
                </Button>
                <Button variant="outline" onClick={handleDownloadPDF} className="font-semibold bg-green-50 hover:bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300 border-green-200 dark:border-green-800">
                  <Download className="w-4 h-4 text-green-600 dark:text-green-400" />
                  Download PDF
                </Button>
                <Button onClick={handleWhatsAppShare} className="font-semibold bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm">
