  ...
  useEffect(() => {
    const unregisterShortcuts = [
      ...
      registerShortcut({
        id: "nav-vehicle",
        combo: "Alt+V",
        description: "Go to Vehicle Register",
        handler: () => setCurrentPage("vehicle-register"),
        group: "Navigation",
      }),
      registerShortcut({
        id: "nav-parties",
        ...
        handler: () => setCurrentPage("parties"),
        group: "Navigation",
      }),
      registerShortcut({
        id: "nav-suppliers",
        ...
        handler: () => setCurrentPage("suppliers"),
        group: "Navigation",
      }),
      registerShortcut({
        id: "nav-ledger",
        ...
        handler: () => setCurrentPage("ledger"),
        group: "Navigation",
      }),
      registerShortcut({
        id: "nav-transactions",
        combo: "Alt+5",
        description: "Go to Sales/Purchase",
        handler: () => setCurrentPage("transactions"),
        group: "Navigation",
      }),
      registerShortcut({
        id: "nav-inventory",
      ...
      registerShortcut({
        ...
        handler: () => setCurrentPage("payments"),
        group: "Navigation",
      }),
      registerShortcut({
        id: "nav-reports",
        ...
        handler: () => setCurrentPage("reports"),
        group: "Navigation",
      }),
      registerShortcut({
        id: "nav-settings",
    ...
    const unregisterCommands = [
      registerCommand({
        ...
        title: "New Entry",
        subtitle: "Trigger new entry workflow",
        shortcut: "Ctrl+N",
        group: "Actions",
        run: () => emitShortcutAction("new-entry"),
      }),
      registerCommand({
        id: "command-save",
        title: "Save",
        subtitle: "Save current record",
        shortcut: "Ctrl+S",
        group: "Actions",
        run: () => emitShortcutAction("save"),
      }),
      registerCommand({
        id: "command-search",
        title: "Search",
    ...
    const unregisterPalette = subscribeShortcutAction(
