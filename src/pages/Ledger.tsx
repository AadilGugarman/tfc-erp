            ...
            <div className="mt-4 p-4 bg-gradient-to-r from-blue-50 to-blue-50/60 dark:from-blue-950/35 dark:to-blue-900/25 rounded-lg border border-blue-200/50 dark:border-blue-800/40">
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <span className="text-sm text-slate-600 dark:text-slate-400">
                  {balance.type === 'receivable' ? '(Receivable)' : '(Payable)'}
                </span>
              </div>
            </div>
          )}
        ...
        <Section title="Ledger Entries">
          {searched.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-slate-500 dark:text-slate-400">No entries found</p>
            </div>
          ) : (
                  ...
                  {searched
                    ...
                    .map(entry => (
                      <PremiumTableRow key={entry.id}>
                        ...
                        <PremiumTableCell className="font-medium">{entry.partyName}</PremiumTableCell>
                        <PremiumTableCell>
                          <div>
      ...
      >
        <div className="space-y-5">
          <PremiumSelect
            ...
            value={selectedParty}
            onChange={e => setSelectedParty(e.target.value)}
            error={!selectedParty && fAmount > 0 ? 'Party is required' : undefined}
            options={[
