...
export const ledgerEntries = sqliteTable(
  ...
  (table) => ({
    ledgerPartyDateIndex: index("idx_ledger_party_date").on(
      table.partyId,
      table.date,
    ),
  }),
...
export const inventoryItems = sqliteTable(
  ...
  (table) => ({
    inventoryNameGradeIndex: index("idx_inventory_name_grade").on(
      table.name,
      table.grade,
    ),
...
export const inventoryTransactions = sqliteTable(
  ...
  (table) => ({
    inventoryTxnItemDateIndex: index("idx_inventory_txn_item_date").on(
      table.itemId,
      table.date,
    ),
    inventoryTxnRefIndex: index("idx_inventory_txn_ref").on(
      table.referenceType,
      table.referenceId,
    ),
  }),
...
export const purchases = sqliteTable(
  ...
  (table) => ({
    ...
    purchasesSupplierIndex: index("idx_purchases_supplier").on(
      table.supplierId,
    ),
  }),
);
...
export const purchaseItems = sqliteTable(
  ...
  (table) => ({
    purchaseItemsPurchaseIndex: index("idx_purchase_items_purchase").on(
      table.purchaseId,
    ),
  }),
);
...
export const vehicleRegisters = sqliteTable(
  "vehicle_registers",
  {
    id: text("id").primaryKey(),
...
export const vehicleRegisterRows = sqliteTable(
  "vehicle_register_rows",
  {
    id: text("id").primaryKey(),
    vehicleRegisterId: text("vehicle_register_id")
      .notNull()
      .references(() => vehicleRegisters.id, { onDelete: "cascade" }),
  ...
  (table) => ({
    vehicleRowsRegisterIndex: index("idx_vehicle_rows_register").on(
      table.vehicleRegisterId,
    ),
    vehicleRowsPartyIndex: index("idx_vehicle_rows_party").on(table.partyId),
    vehicleRowsInventoryIndex: index("idx_vehicle_rows_inventory").on(
